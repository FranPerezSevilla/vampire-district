...
Record every third-party audio asset here before merging it into the game.

| Catalogue ID | File | Title / description | Author | Source | Licence | Changes |
| --- | --- | --- | --- | --- | --- | --- |
| _example_ | `vehicle/vehicle-door-close-01.ogg` | Car door close | Example Author | Source page URL | CC0 | Trimmed, normalized |
...
- Do not delete attribution merely because an asset was edited.
