...
export const VEHICLE_ARCHETYPES = Object.freeze({
  compact: Object.freeze({
    ...
    reverseSpeed: 66,
    acceleration: 122,
    reverseAcceleration: 78,
    brake: 214,
    drag: 54,
    steerRate: 2.55,
    maxHealth: 72,
    trunkCapacity: 2,
    cameraZoomFactor: 0.78,
    color: 0x78c7a3,
    trim: 0xd7ffec
  }),
  sedan: Object.freeze({
    ...
    reverseSpeed: 72,
    acceleration: 112,
    reverseAcceleration: 74,
    brake: 202,
    drag: 48,
    steerRate: 2.30,
    maxHealth: 88,
    trunkCapacity: 4,
    cameraZoomFactor: 0.74,
    color: 0x9a7ab8,
    trim: 0xefe6ff
  }),
  van: Object.freeze({
    ...
    reverseSpeed: 58,
    acceleration: 86,
    reverseAcceleration: 62,
    brake: 184,
    drag: 44,
    steerRate: 1.82,
    maxHealth: 118,
    trunkCapacity: 7,
    cameraZoomFactor: 0.80,
    color: 0x6e5b37,
    trim: 0xffcf87
  }),
  police: Object.freeze({
    ...
    reverseSpeed: 76,
    acceleration: 132,
    reverseAcceleration: 82,
    brake: 224,
    drag: 50,
    steerRate: 2.42,
    maxHealth: 104,
    trunkCapacity: 3,
    cameraZoomFactor: 0.70,
    color: 0x294c7a,
    trim: 0x9dcaff
  })
});
...
export const vehicleDefinitions = Object.freeze([
  ...
  Object.freeze({
    ...
    startOwned: false,
    ownerId: "market_resident",
    factionId: null,
    parked: true
  }),
  Object.freeze({
    id: "directorate_van",
    name: "Directorate van",
    archetypeId: "van",
    x: 286,
    y: 536,
    angle: 0,
    layer: LAYERS.STREET,
    ownership: VEHICLE_OWNERSHIP.FACTION,
    startOwned: false,
    ownerId: "directorate_cleaner",
    factionId: "blackglass_directorate",
    parked: true
  }),
  Object.freeze({
    id: "police_cruiser",
    ...
    angle: Math.PI / 2,
    layer: LAYERS.STREET,
    ownership: VEHICLE_OWNERSHIP.POLICE,
    startOwned: false,
    ownerId: "city_police",
    factionId: "city_police",
    parked: true
  })
]);
