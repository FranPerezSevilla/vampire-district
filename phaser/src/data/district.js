...
export const buildings = [
  ...
  { id: "church", name: "CHURCH", x: 800, y: 418, w: 124, h: 126, color: 0x1b1824, trim: 0x8b6f9e, sign: "CHURCH" },
...
export const roofAreas = {
  [LAYERS.ROOF_LOW]: [
    ...
    { id: "churchRoof", x: 806, y: 424, w: 112, h: 114, color: 0x2a2538, label: "CHURCH" }
  ],
  [LAYERS.ROOF_HIGH]: [
...
export const lights = [
  ...
  { id: "lampChurch", x: 842, y: 404, radius: 70, name: "church streetlight" },
...
export const shadowZones = [
  ...
  { id: "clubSideShadow", name: "club side shadow", x: 546, y: 340, w: 88, h: 34, strength: 0.70 },
  { id: "clubRearShadow", name: "club rear shadow", x: 584, y: 486, w: 190, h: 34, strength: 0.66 },
  { id: "churchRearShadow", name: "church rear shadow", x: 778, y: 546, w: 150, h: 34, strength: 0.68 }
];
...
export const rooftopRoutes = [
  ...
  { id: "jumpClubChurch", ax: 754, ay: 430, bx: 806, by: 480, aLayer: LAYERS.ROOF_LOW, bLayer: LAYERS.ROOF_LOW, aToB: "jump to church", bToA: "jump to club" }
];
...
export const fireEscapes = [
  ...
  { id: "churchFireEscape", name: "church fire escape", street: { x: 782, y: 500 }, roof: { layer: LAYERS.ROOF_LOW, x: 860, y: 490 } }
];
...
export const sewerAccesses = [
  ...
  { id: "churchManhole", name: "church rear manhole", street: { x: 842, y: 500 }, sewer: { x: 742, y: 500 } },
...
export const bodyHideSpots = [
  ...
  { id: "dumpsterChurchRear", name: "church rear dumpster", layer: LAYERS.STREET, x: 850, y: 556, radius: 36 },
