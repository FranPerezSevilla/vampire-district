...
export const npcDefinitions = [
  // Civilians: enough life to validate crowd placement without advanced AI yet.
  ...
  { id: "civ_east_1", type: NPC_TYPES.CIVILIAN, x: 586, y: 326, layer: LAYERS.STREET, behavior: "wander", speed: 11 },
  { id: "civ_east_2", type: NPC_TYPES.CIVILIAN, x: 670, y: 326, layer: LAYERS.STREET, behavior: "wander", speed: 10 },
  { id: "civ_west_2", type: NPC_TYPES.CIVILIAN, x: 246, y: 326, layer: LAYERS.STREET, behavior: "wander", speed: 10 },
  { id: "civ_club", type: NPC_TYPES.CIVILIAN, x: 642, y: 406, layer: LAYERS.STREET, behavior: "loiter", speed: 5 },
  { id: "civ_church", type: NPC_TYPES.CIVILIAN, x: 720, y: 456, layer: LAYERS.STREET, behavior: "loiter", speed: 5 },
  ...
  // Mission target placeholder. Feeding/lure will replace the placeholder interaction later.
  { id: "journalist", type: NPC_TYPES.TARGET, x: 638, y: 370, layer: LAYERS.STREET, behavior: "loiter", speed: 4 },

  // Threat placeholders. They exist as anchors but do not chase until later phases.
  { id: "police_anchor", type: NPC_TYPES.POLICE, x: 780, y: 178, layer: LAYERS.STREET, behavior: "guard", speed: 0, inactive: true },
  { id: "hunter_church_1", type: NPC_TYPES.HUNTER, x: 742, y: 474, layer: LAYERS.STREET, behavior: "hidden", speed: 0, inactive: true },
