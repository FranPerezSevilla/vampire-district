...
export const VAMPIRE_ASSETS = Object.freeze([
  { id: "club", name: "Club feeding rooms", contactId: "vesper", buildingId: "club", districtId: "old-quarter", price: 600, income: 85, bags: 0, description: "Admission income and a hunting agreement brokered by Vesper. The district itself is not for sale." },
